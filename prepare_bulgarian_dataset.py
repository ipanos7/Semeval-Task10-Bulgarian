...
def main():
    ...
    # Paths
    raw_data_folder = os.path.join(current_dir, "data", "bulgarian_raw-documents")
    ...
    all_labels_file = os.path.join(current_dir, "data", "bulgarian_all_labels.json")
    processed_annotations_file = os.path.join(current_dir, "data", "bulgarian_processed_annotations.json")
    training_dataset_file = os.path.join(current_dir, "data", "bulgarian_training_dataset.json")
